...
class MovementsTest < ApplicationSystemTestCase
  ...
  test "should create movement" do
    ...
    fill_in "Concept", with: @movement.concept
    fill_in "Description", with: @movement.description
    fill_in "Movement date", with: @movement.movement_date
    fill_in "Original amount", with: @movement.original_amount
    fill_in "Original currency", with: @movement.original_currency
    fill_in "Settled date", with: @movement.settled_date
